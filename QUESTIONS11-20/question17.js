...
while (guestlist.length > 2) {
    ...
    console.log("Sorry, ".concat(removeguest, " i am cancelling the dinner for some personal reason "));
}
//printinf final message
console.log("Invitation to the last 2 guests");
guestlist.forEach(function (lasttwo) { return console.log("You ".concat(lasttwo, ", still invited to dinner")); });
